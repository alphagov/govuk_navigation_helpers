...
require "govuk_navigation_helpers/navigation_sidebar"
...
module GovukNavigationHelpers
  class NavigationHelper
    ...
    # Generate a payload containing navigation sidebar data. Intended for use with
    # the navigation sidebar component
    #
    # @return [Hash] Payload for the GOV.UK navigation sidebar component
    # @see https://government-frontend.herokuapp.com/component-guide/navigation-sidebar
    def navigation_sidebar
      NavigationSidebar.new(content_item).navigation_sidebar
    end
